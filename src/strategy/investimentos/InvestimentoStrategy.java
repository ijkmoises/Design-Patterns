...
public interface InvestimentoStrategy {
	double calcula(Conta saldo);
}

class Conservador implements InvestimentoStrategy{
    public double calcula(Conta conta) {
      return conta.getSaldo() * 0.008;
    } 
  }

class Moderado implements InvestimentoStrategy {
...
class Arrojado implements InvestimentoStrategy {
    private Random random;
